        ...
        if refresh and can_sync_shopify() and start and end:
            ...
            if req_start <= req_end:
                try:
                    ...
                    # Roll back the failed transaction before this request attempts
                    # any further ORM work. Include the database's safe constraint
                    # detail so Vercel logs identify the exact table/index/column.
                    db.session.rollback()
